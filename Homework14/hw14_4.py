...
# отчеством "Ivanovich" и убедитесь,
...
# отчество "Ivanovich", возраст 30, должность "manager" и зарплата 50000.
...
# что атрибут last_name не возвращает в верхнем регистре "Ivan".
#
